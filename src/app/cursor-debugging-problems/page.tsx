              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="modern-card">
                  <h3 className="text-xl font-bold mb-4 text-white flex items-center">
                    <FiAlertCircle className="mr-3 h-5 w-5 text-red-400" />
                    Frontend Issues
                  </h3>
                ...
                <div className="modern-card">
                  <h3 className="text-xl font-bold mb-4 text-white flex items-center">
                    <FiAlertCircle className="mr-3 h-5 w-5 text-blue-400" />
                    Backend Issues
                  </h3>
                  <ul className="space-y-2 text-gray-300">
                ...
                <div className="modern-card">
                  <h3 className="text-xl font-bold mb-4 text-white flex items-center">
                    <FiAlertCircle className="mr-3 h-5 w-5 text-green-400" />
                    Integration Issues
                  </h3>
                  <ul className="space-y-2 text-gray-300">
                ...
                <div className="modern-card">
                  <h3 className="text-xl font-bold mb-4 text-white flex items-center">
                    <FiAlertCircle className="mr-3 h-5 w-5 text-purple-400" />
